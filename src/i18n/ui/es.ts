export default {
  ...
  footer: {
    ...
    toaster: {
      ...
      unexpected: {
        ...
        message: "Ocurrió un problema, intenta nuevamente más tarde",
      },
    },
  },
  cta: {
  ...
  home: {
    ...
    about: {
      title: "Transformando ideas en software desde",
      year: "2022",
      description:
  ...
  contact: {
    ...
    form: {
      ...
      toaster: {
        success: {
          title: "¡Tu mensaje llegó con éxito 🚀!",
          message:
            "Muy pronto me pondre en contacto para seguir avanzando juntos 💡🤝",
        },
        telegramFail: {
          title: "Error al enviar",
          message: "No se pudo enviar el mensaje a Telegram",
  ...
  blog: {
    ...
    subtitle:
      "Descubre el criterio y las decisiones que transforman el desarrollo en productos digitales eficientes, escalables y preparados para nuevos retos.",
    labelAll: "Todo",
  },
  post: {
    back: "Volver",
